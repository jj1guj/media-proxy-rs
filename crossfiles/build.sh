...
export RUSTFLAGS="${RUSTFLAGS} -C target-feature=-crt-static -L native=/vips-system-lib -L native=/vips/lib -C link-arg=-Wl,-rpath-link,/vips-system-lib -C link-arg=-Wl,-rpath-link,/vips/lib"
